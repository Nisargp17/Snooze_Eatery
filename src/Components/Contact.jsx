      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="mb-4 text-gray-700">
            Whether you’re planning an event, asking a question, or just want to
          ...
          <ul className="text-gray-800 space-y-2">
            ...
            <li>
              📧 <strong>Email:</strong>{" "}
              <a href="mailto:hello@snoozeeatery.com">hello@snoozeeatery.com</a>
            </li>
            <li>
              📍 <strong>Address:</strong> 123 Sunny Lane, Foodie City, NY 10001
            </li>
          </ul>
